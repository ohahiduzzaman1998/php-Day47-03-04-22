...
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4 text-center">Edit Blog Form</h4>
                    ...
                    <form method="POST" action="{{route('blog.update',['id'=>$blog->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{$blog->sub_title}}" class="form-control" name="sub_title" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
